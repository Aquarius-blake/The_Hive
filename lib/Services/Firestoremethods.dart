    ...
    Future<String> CreateGroup(String uid,String author,String grpname,String grpdesc,dynamic file,User1 user)async{
      ...
      try{
        ...
        if(file!=null){
            ...
            Group group= Group(Post_name: "Posts",noP: 0,Header: "",author_uid: uid, Group_uid: groupid, author: author, Timeposted: DateTime.now(), members: members, Group_name: grpname, Group_description: grpdesc,ppurl: photourl,Identity: "Members");
